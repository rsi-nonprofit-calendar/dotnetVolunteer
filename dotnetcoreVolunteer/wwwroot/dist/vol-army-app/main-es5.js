...
var AnimalsCategoryComponent = /** @class */ (function () {
    function AnimalsCategoryComponent(modalService) {
        this.modalService = modalService;
    }
    AnimalsCategoryComponent.prototype.open = function (content) {
        var _this = this;
        this.modalService
    ...
    AnimalsCategoryComponent.ctorParameters = function () { return [
    ...
    return AnimalsCategoryComponent;
}());
...
var AppComponent = /** @class */ (function () {
    function AppComponent(modalService, cookieService) {
        this.modalService = modalService;
...
var CalendarService = /** @class */ (function () {
    ...
    CalendarService.prototype.onSubmit = function () {
        var _this = this;
        this.http.post(this.url, this.posts).subscribe(function (r) {
            _this.posts.push(r);
        });
    };
...
var CalendarComponent = /** @class */ (function () {
    function CalendarComponent(modal, http, service) {
        var _this = this;
        this.modal = modal;
        this.http = http;
...
var CategoriesComponent = /** @class */ (function () {
    function CategoriesComponent(router, modalService) {
        this.router = router;
        this.modalService = modalService;
    }
...
var ChildrenCategoryComponent = /** @class */ (function () {
    function ChildrenCategoryComponent() {
    }
    ChildrenCategoryComponent.prototype.ngOnInit = function () {
    };
    ...
    return ChildrenCategoryComponent;
}());
...
var CreateEventComponent = /** @class */ (function () {
    function CreateEventComponent(http) {
        this.http = http;
        this.url = "http://jsonplaceholder.typicode.com/posts";
    }
    ...
    CreateEventComponent.prototype.onSubmit = function (f) {
        var _this = this;
        var post = { event: f };
        this.http.post(this.url, post).subscribe(function (response) {
            _this.posts.push(response);
            _this.eventForm.resetForm();
        });
    };
    ;
...
var EducationCategoryComponent = /** @class */ (function () {
    function EducationCategoryComponent() {
    }
    EducationCategoryComponent.prototype.ngOnInit = function () {
    };
    ...
    return EducationCategoryComponent;
}());
...
var EnvironmentCategoryComponent = /** @class */ (function () {
    function EnvironmentCategoryComponent() {
    }
    EnvironmentCategoryComponent.prototype.ngOnInit = function () {
    };
    ...
    return EnvironmentCategoryComponent;
}());
...
var EqualityCategoryComponent = /** @class */ (function () {
    function EqualityCategoryComponent() {
    }
    EqualityCategoryComponent.prototype.ngOnInit = function () {
    };
    ...
    return EqualityCategoryComponent;
}());
...
var HealthcareCategoryComponent = /** @class */ (function () {
    function HealthcareCategoryComponent() {
    }
    HealthcareCategoryComponent.prototype.ngOnInit = function () {
    };
    ...
    return HealthcareCategoryComponent;
}());
...
var HousingCategoryComponent = /** @class */ (function () {
    function HousingCategoryComponent() {
    }
    HousingCategoryComponent.prototype.ngOnInit = function () {
    };
    ...
    return HousingCategoryComponent;
}());
...
var JoinEventComponent = /** @class */ (function () {
    function JoinEventComponent(service) {
        this.service = service;
    }
    JoinEventComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getDetails().subscribe(function (response) {
...
var JoinEventService = /** @class */ (function () {
    function JoinEventService(http) {
        this.http = http;
        this.url = "http://jsonplaceholder.typicode.com/posts";
    }
    JoinEventService.prototype.getDetails = function () {
        return this.http.get(this.url);
    };
    JoinEventService.ctorParameters = function () { return [
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.CreateUser = function (register) {
        var httpOptions = {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, LoginService, cookie) {
        this.router = router;
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.LoginService.Login(this.model).subscribe(function (response) {
            _this.model = response.filter(function (u) { return u.userType === "Org"; }); //  instead of userId of 2, pass in dynamic variable which will be userId of logged in user.  
        });
        // routeUser(userType) {
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(router, modalService) {
        this.router = router;
        this.modalService = modalService;
        this.appTitle = "myapp";
    }
...
var NonprofitComponent = /** @class */ (function () {
    function NonprofitComponent() {
    }
    NonprofitComponent.prototype.ngOnInit = function () {
    };
...
var OrganizationDashboardComponent = /** @class */ (function () {
    function OrganizationDashboardComponent(service) {
        this.service = service;
    }
    OrganizationDashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getDetails().subscribe(function (response) {
            _this.details = response.filter(function (p) { return p.userId === 3; }); //  instead of userId of 2, pass in dynamic variable which will be userId of logged in user.  
        });
    };
    OrganizationDashboardComponent.prototype.updateFilter = function (id) {
        this.filteredResults = id ? this.details.filter(function (p) { return p.userId === id; }) : this.details;
    };
    OrganizationDashboardComponent.ctorParameters = function () { return [
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(formbulider, loginService) {
    ...
    RegisterComponent.prototype.CreateNewUser = function (register) {
        var _this = this;
        this.loginService.CreateUser(register).subscribe(function () {
            _this.data = true;
            _this.massage = "Data saved Successfully";
...
var SplashComponent = /** @class */ (function () {
    function SplashComponent(router, modalService) {
        this.router = router;
        this.modalService = modalService;
    }
...
var TechnologyCategoryComponent = /** @class */ (function () {
    function TechnologyCategoryComponent() {
    }
    TechnologyCategoryComponent.prototype.ngOnInit = function () {
    };
    ...
    return TechnologyCategoryComponent;
}());
...
var TransportationCategoryComponent = /** @class */ (function () {
    function TransportationCategoryComponent(modalService) {
        this.modalService = modalService;
    }
    TransportationCategoryComponent.prototype.open = function (content) {
        var _this = this;
        this.modalService
            .open(content, { ariaLabelledBy: "modal-basic-title" })
            .result.then(function (result) {
    ...
    TransportationCategoryComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbModal"] }
    ]; };
    ...
    return TransportationCategoryComponent;
}());
...
var VolunteerDashboardComponent = /** @class */ (function () {
    function VolunteerDashboardComponent(service) {
        this.service = service;
    }
    VolunteerDashboardComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getDetails().subscribe(function (response) {
            _this.details = response.filter(function (p) { return p.userId === 2; }); //  instead of userId of 2, pass in dynamic variable which will be userId of logged in user.  
        });
    };
    VolunteerDashboardComponent.prototype.updateFilter = function (id) {
        this.filteredResults = id ? this.details.filter(function (p) { return p.userId === id; }) : this.details;
    };
    VolunteerDashboardComponent.ctorParameters = function () { return [
        { type: _join_event_join_event_service__WEBPACK_IMPORTED_MODULE_1__["JoinEventService"] }
    ]; };
    ...
    return VolunteerDashboardComponent;
}());
...
var WatermelonMountainRanchComponent = /** @class */ (function () {
    function WatermelonMountainRanchComponent() {
    }
    WatermelonMountainRanchComponent.prototype.ngOnInit = function () {
    };
    ...
    return WatermelonMountainRanchComponent;
}());
